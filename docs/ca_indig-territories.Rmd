...
The statement below could contribute to a more inclusive Land Acknowledgment statement, recognizing the role the 1862 Morrill Act played in transforming land that had been seized from Native Americans through [centuries of violence and occupation](https://yalebooks.yale.edu/book/9780300181364/american-genocide){target="_blank" rel="noopener"} by Spaniards, Mexicans, and Euro-Americans, into an endowment for the nascent University of California. 
...
<p style="font-size:120%; margin:0 2em;">The University of California was established in part with the proceeds from land seized from the <em>`r paste(tribe_names, collapse=", ")`</em> tribes. [Details](https://ucanr-igis.github.io/morrill-map/ca_indig-territories.html).</p>

\

# 6. Next Steps

1\) Although the boundaries and records of parcels allocated under the Morrill Act are fairly well-established, the are other databases and spatial layers showing the distribution of California's Native American groups (including the Royce Cession Maps which are already encoded in the Lee (2020) database). 

2\) Add Tribes who were the original land stewards at current UC holdings (primarily the campuses and field stations).
