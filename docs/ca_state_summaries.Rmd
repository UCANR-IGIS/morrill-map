...
This analysis tabulates the amount of land that was given out in California under the 1862 Morrill Act, to support the establishment of Land Grant Universities throughout the US. For more information on the Morrill Act, and the role it played in establishing public universities in the US, see [Wikipedia](https://en.wikipedia.org/wiki/Morrill_Land-Grant_Acts){target="_blank" rel="noopener"}.
...
Cross-check the parcel data by mapping it:
...
The majority of land in California transferred from Federal to private ownership under the Morrill Act actually went to benefit public universities in other States. States like New York received a large allotment of land (which was distributed according to population), but 
